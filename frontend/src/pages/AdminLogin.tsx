    ...
    <>
      ...
      <div className="min-h-[70vh] bg-cream-100 flex items-center justify-center py-14 px-4">
        <div className="max-w-md w-full bg-cream-50 rounded border border-cream-300/80 p-7 sm:p-8 shadow-subtle">
          ...
          <div className="w-12 h-12 rounded bg-forest-800 text-saffron-400 mx-auto flex items-center justify-center mb-4 border border-forest-700/60 shadow-subtle">
          ...
          <p className="text-xs text-center text-charcoal-800/60 font-sans mb-6">
            Sign in to manage restaurant menu, gallery, settings, and reservations.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-sans">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin"
                  className="w-full pl-8 pr-3.5 py-2.5 bg-cream-100/90 border border-cream-300/80 rounded text-xs text-charcoal-900 focus:outline-none focus:border-forest-800 transition-colors"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded bg-forest-800 text-cream-50 font-medium text-xs uppercase tracking-widest hover:bg-forest-700 transition-colors shadow-subtle flex items-center justify-center gap-2 mt-5 disabled:opacity-70"
            >
              {isSubmitting ? (
                <>
